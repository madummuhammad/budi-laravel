                                            ...
                                            <div class="col-lg-12">
                                                ...
                                                <div class="row row-cols-3">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <select name="sub_district" id="" class="form-select">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <select id="status" class="form-control"
                                                        aria-label="size 3 select example" placeholder="" name="status">
                                                        <option value="">--pilih--</option>
                                                        <option value="Siswa" @if (auth()->
                                                            guard('visitor')->user()->profession == 'Siswa') selected
                                                            @endif>Siswa
                                                        </option>
                                                        <option value="Guru / Tenaga Pendidik" @if (auth()->
                                                            guard('visitor')->user()->profession == 'Guru / Tenaga
                                                            Pendidik') selected @endif>Guru/
                                                            Tenaga Pendidik
                                                        </option>
                                                        <option value="Orang Tua Siswa" @if (auth()->
                                                            guard('visitor')->user()->profession == 'Orang Tua Siswa')
                                                            selected @endif>Orang Tua
                                                            Siswa</option>
                                                        <option value="Umum" @if (auth()->
                                                            guard('visitor')->user()->profession == 'Umum') selected
                                                            @endif>Umum
                                                        </option>
                                                    </select>
                                                    {{-- <input type="text" class="form-control" id="exampleInputEmail1"
                                                ...
                                                <div class="form-group" id="sub-status">
                                                    ...
                                                    <select id="sub-status" class="form-control"
                                                        ...
                                                        name="sub-status">
                                                        <option value="">--pilih--</option>
                                                        <option value="SD" @if (auth()->guard('visitor')->user()->level
                                                            == 'SD') selected @endif>
                                                            SD</option>
                                                        <option value="SMP" @if (auth()->guard('visitor')->user()->level
                                                            == 'SMP') selected @endif>
                                                            SMP</option>
                                                        <option value="SMA" @if (auth()->guard('visitor')->user()->level
                                                            == 'SMA') selected @endif>
                                                            SMA</option>
                                                    </select>
                                                </div>
                                                ...
                                                <div class="form-group" id="sub-status">
                                                    ...
                                                    <select class="form-control" aria-label="size 3 select example"
                                                        placeholder="" name="sub-status">
                                                        <option value="">--pilih--</option>
                                                        <option value="PAUD" @if (auth()->
                                                            guard('visitor')->user()->level == 'PAUD') selected @endif>
                                                            PAUD</option>
                                                        <option value="SD" @if (auth()->guard('visitor')->user()->level
                                                            == 'SD') selected @endif>
                                                            SD</option>
            ...
            <div class="mb-3">
                <div class="row mb-3">
                    <div class="col-4 col-md-3 d-flex">
                        <div class="me-2"> <img style="max-widht: 20px;" src="{{ asset('web') }}/assets/icon/email.svg"
                                alt="">
                        </div>
                ...
                <div class="row mb-3">
                    <div class="col-4 col-md-3 d-flex">
                        <div class="me-2"><img style="max-widht: 20px;" src="{{ asset('web') }}/assets/icon/medal.svg"
                                alt="">
                        </div>
                ...
                <div class="row mb-3">
                    <div class="col-4 col-md-3 d-flex">
                        <div class="me-2"><img style="max-widht: 20px;" src="{{ asset('web') }}/assets/icon/pin-2.svg"
                                alt="">
                        </div>
                ...
                <div class="row mb-3">
                    <div class="col-4 col-md-3 d-flex">
                        <div class="me-2"><img style="max-widht: 20px;" src="{{ asset('web') }}/assets/icon/profesi.svg"
                                alt="">
                        </div>
                ...
                <div class="row mb-3">
                    <div class="col-4 col-md-3 d-flex">
                        <div class="me-2"><img style="max-widht: 20px;" src="{{ asset('web') }}/assets/icon/toga.svg"
                                alt="">
                        </div>
...
<div class="container-fluid">
    ...
    <div class="row my-5">
        <div class="col-12">
            <div class="px-4 profile-achive-container">
