            ...
            <div class="row mt-4 text-center text-lg-start">
                <div class="col-12 col-md-6">
                    <div class="d-flex flex-column flex-lg-row align-items-center align-items-lg-start">
                        <img src="{{ asset('web') }}/assets/icon/evelope.svg" class="mb-2 mb-lg-0 mr-lg-2 me-lg-2" style="max-height: 20px">
                    ...
                    <div class="d-flex flex-column flex-lg-row align-items-center align-items-lg-start mt-4">
                        <img src="{{ asset('web') }}/assets/icon/pin.svg" class="mb-2 mb-lg-0 mr-lg-2 me-lg-2" style="max-height: 20px">
                ...
                <div class="col-12 col-md-6">
                    <div class="d-flex flex-column flex-lg-row align-items-center align-items-lg-start mt-4 mt-md-0">
                        <img src="{{ asset('web') }}/assets/icon/telephone.svg" class="mb-2 mb-lg-0 mr-lg-2 me-lg-2" style="max-height: 20px">
                        <span>(021) 4750406</span>
                    </div>

                    <div class="d-flex flex-column flex-lg-row align-items-center align-items-lg-start mt-4">
                        <img src="{{ asset('web') }}/assets/icon/clock.svg" class="mb-2 mb-lg-0 mr-lg-2 me-lg-2" style="max-height: 20px">
                        <div>
    ...
    <div class="container p-lg-5 py-5 px-4">
        <div class="row">
            <div class="col-12 col-md-6">
                ...
                <form action="">
                    <div class="mb-3">
                        <input type="text" class="form-control py-3" id="exampleFormControlInput1" placeholder="Nama">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <textarea name="" id="" cols="30" rows="10" class="form-control py-3"
            ...
            <div class="col-12 col-md-6 order-first order-md-last">
                <img src="{{ asset('web') }}/assets/img/kirim_pesan.png" alt="" class="img-fluid d-none d-md-block">
            </div>
        </div>
    </div>
</div>
