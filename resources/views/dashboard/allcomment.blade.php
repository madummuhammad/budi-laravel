...
<div class="content-body">
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4 class="card-title">Komentar Buku</h4>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="example" class="display" style="min-width: 845px">
                                ...
                                <div class="modal fade" id="edit{{ $comment->id }}" tabindex="-1"
                                    ...
                                    <div class="modal-dialog ">
                                        ...
                                        @foreach($comment->books as $book)
                                        <form action="{{ url('dashboard/book/comment/') }}/{{ $book->id }}"
    ...
    <div class="col-12">
        <div class="card">
            <div class="card-header">
                <h4 class="card-title">Komentar Referensi</h4>
            </div>
            <div class="card-body">
                <div class="table-responsive">
                    <table class="display table-table" style="min-width: 845px">
                        ...
                        <tbody>
                            ...
                            $no = 0;
                            @endphp
                            @foreach ($reference_books as $comment)
                            @php
                            $no++;
                            @endphp
                            <tr>
                                ...
                                @foreach($comment->reference_books as $book)
                                <td>{{ $book->name }}</td>
                                @endforeach
                                <td>
                                    <button class="btn badge badge-danger" data-toggle="modal"
                                    data-target="#hapuss{{$comment->id}}"><i
                                    class="bi bi-trash3"></i></button>
                                    <div class="modal" tabindex="-1" id="hapuss{{ $comment->id }}">
                                        <div class="modal-dialog modal-dialog-centered modal-sm">
                                            <div class="modal-content">
                                                <div class="modal-header border-0 py-0">
                                                    <h5 class="modal-title"></h5>
                                            ...
                                            <div class="modal-footer pt-0 pb-1 border-0">
                                                @foreach($comment->reference_books as $book)
                                                <form action="{{ url('dashboard/statistic/referensi/comment/') }}/{{ $book->id }}" method="POST">
                                                    @endforeach
                                                    @csrf
                                                    @method('delete')
                                                    <input type="text" name="id"
                                    ...
                                    <button class="btn badge badge-primary" data-toggle="modal"
                                    data-target="#editd{{ $comment->id }}"><i
                                    class="bi bi-pencil-square"></i></button>
                                </td> 
                            </tr>
                            <div class="modal fade" id="editd{{ $comment->id }}" tabindex="-1"
                                aria-labelledby="exampleModalLabel" aria-hidden="true">
                                <div class="modal-dialog ">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                    ...
                                    @foreach($comment->reference_books as $book)
                                    <form action="{{ url('dashboard/statistic/referensi/comment/') }}/{{ $book->id }}"
                                    method="POST" enctype="multipart/form-data">
                                    @endforeach
                                    <div class="modal-body">
                                        @method('patch')
